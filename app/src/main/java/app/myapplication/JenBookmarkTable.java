...
public class JenBookmarkTable extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "_pouch_bookmark";
    public static final String TABLE_NAME = "[by-sequence]";

    private static String SQL_CREATE_ENTRIES = "CREATE TABLE '"+JenBookmarkTable.TABLE_NAME
            +"' (seq INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, json, deleted TINYINT(1), doc_id, rev);";
    private static String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS "+JenBookmarkTable.TABLE_NAME;

    public JenBookmarkTable(Context context) {
