...
public class JenSkillTable extends SQLiteOpenHelper{
    public static final String DATABASE_NAME = "_pouch_skill";
    public static final String TABLE_NAME = "by-sequence";
    public static final String TABLE_NAME2 = "[by-sequence]";

    private static String SQL_CREATE_ENTRIES = "CREATE TABLE '"+JenSkillTable.TABLE_NAME
            +"' (seq INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, json, deleted TINYINT(1), doc_id, rev);";
    private static String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS '"+JenSkillTable.TABLE_NAME+"'";

    public JenSkillTable(Context context) {
