...
public class JenWorkTable extends SQLiteOpenHelper{
    public static final String DATABASE_NAME = "_pouch_work";
    public static final String TABLE_NAME = "by-sequence";
    public static final String TABLE_NAME2 = "[by-sequence]";

    private static String SQL_CREATE_ENTRIES = "CREATE TABLE '"+JenWorkTable.TABLE_NAME
            +"' (seq INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, json, deleted TINYINT(1), doc_id, rev);";
    private static String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS '"+JenWorkTable.TABLE_NAME+"'";

    public JenWorkTable(Context context) {
